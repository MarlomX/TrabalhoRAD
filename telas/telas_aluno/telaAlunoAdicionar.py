...
class TelaAlunoAdicionar:
    ...
    def criar_campos(self):
        ...
        self.label_titulo = tk.Label(self.root, text="Adicionar Aluno", font=("Helvetica", 16))
    ...
    def criar_botoes(self):
        self.btn_adicionar = tk.Button(self.root, text="Adicionar", font=("Arial", 14), command=self.adicionar_aluno)
    ...
    def adicionar_aluno(self):
        ...
        AlunoRepositorio.Adiciona_Aluno(aluno=aluno)
    ...
    def confirma_campos(self):
        ...
        Utilidades.valida_nome_pessoa(nome=self.entry_nome.get()) and\
            Utilidades.valida_matricula(self.entry_matricula.get(), "Aluno"):
            return True
        else:
            return False
    
if __name__ == "__main__":
    app = TelaAlunoAdicionar()
